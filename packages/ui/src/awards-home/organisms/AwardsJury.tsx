...
function JuryItem({ member }: { member: JuryMember }) {
  ...
  return (
    <article className="speakers-collection-item is--interactive awards-jury-card">
      ...
      <div className="speakers-item_name-2 awards-jury-card__content">
        <h3 className="ways25-heading5 text-size-32 awards-jury-card__name">{member.name}</h3>
        <p className="is--paragraph awards-jury-card__role" aria-hidden={role ? undefined : true}>
          {role || "\u00a0"}
        </p>
      </div>
  ...
  return (
    <div className="section-hero-wrapper awards-jury">
      <div className="home-speakers-content">
        ...
        {isLoading ? (
          <p className="is--paragraph is--text-color-silver awards-jury-placeholder">
            Loading jury members...
          </p>
        ) : error && members.length === 0 ? (
          <p className="is--paragraph is--text-color-silver awards-jury-placeholder">{error}</p>
        ) : members.length === 0 ? (
          <p className="is--paragraph is--text-color-silver awards-jury-placeholder">
          ...
          <div className="speakers-collection-wrapper">
            ...
            {shouldShowMoreButton ? (
              <div className="awards-jury-more">
